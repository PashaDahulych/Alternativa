(() => {
    ...
    function initSliders() {
        if (document.querySelector(".testination__slider")) new swiper_core_Swiper(".testination__slider", {
            ...
            loop: true,
            pagination: {
                el: ".testination__swiper-pagination",
                clickable: true,
                type: "fraction"
            },
            navigation: {
                prevEl: ".testination__swiper-button-prev",
                nextEl: ".testination__swiper-button-next"
            },
            breakpoints: {
                319: {
                    slidesPerView: 1,
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        function handleScreenSizeChange(e) {
            if (e.matches) addEventListeners(); else removeEventListeners();
        }
